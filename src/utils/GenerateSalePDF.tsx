...

        {
          columns: [
            ...
            [
              ...
              { text: `Tasa de cambio: $${exchangeRate} COP` },
            ],
          ],
        },
...

        {
          ...
          table: {
            ...
            body: [
              ...
              ["Aranceles", `${currency} ${customsDuties?.toFixed(2)}`],
              ["Gastos aduaneros", `${currency} ${customsHandlingCost?.toFixed(2)}`],
              ...
              [
                ...
                {
                  text: `COP ${(
                    Number(totalPrice) * (exchangeRate ?? 0)
